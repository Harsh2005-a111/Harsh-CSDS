...
int main() {
  ...
  for (int i : mynum) { //using for - each loop(Syntax : type varname : arrayname)
    cout << i << "\n"; 
  }
}
*/
...
int main() {
  int mynum [5] = {10,20,30,40,50};
  mynum[3] = 100;
  cout << mynum; // You will be getting output as 0x61fefc. 
                 // You can't access all the elements of the array by coding
                 // cout << mynum. You have to use loops for this purpose...
  return 0;
}
*/
/*
...
// Creating array based on user's choice...
/*
#include <iostream>
...
int main() {
  string cars[];  // Array size is not specified. Error..
  cars[0] = "Volvo"; 
  cars[1] = "BMW";
  cars[2] = "Ford"; 
  cars[3] = "Mazda";
...
int main() {
  cout << " Enter value of n for array size :  ";
  int n;
  cin >> n;
  string cars[n];  // Array size is specified. No Error
  int i = 0;
  while (i < n){
    cars[i];
    cin >> cars[i];
...
int main(){
  int mynum[5] ={10,20,30,40,50};
  cout << "Count of integers (in bytes) :" << sizeof(mynum) << '\n';  
                          // Displayes 20 instead of 5. Why??
                          // Each integer contain 4 bytes.
                          // So 4*5 = 20 (Here 4 is the byte count when n = 1)
                          // for n = 5 we just multiply.  

  cout << "Count of integers            :" << sizeof(mynum)/sizeof(int) << '\n';
  for (int i : mynum){
    cout << i << '\n';
  }
}
...
// Calculating Average of data stored in Array
/*
# include <iostream>
...
int main() {
  ...
  cout << "Sum     : " << sum << '\n' ;
  cout << "Average : " << (sum)/(sizeof(num)/sizeof(int)) << '\n' ;
  cout << "Minimum : " << min << '\n';
  cout << "Maximum : " << max ;
}
*/
